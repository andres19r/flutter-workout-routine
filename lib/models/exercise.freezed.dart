...
mixin _$Exercise {
 ...
 String get name; String get sets; String get reps; String? get intensity; String? get note;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,sets,reps,intensity,note);

@override
String toString() {
  return 'Exercise(name: $name, sets: $sets, reps: $reps, intensity: $intensity, note: $note)';
}
...
@useResult
$Res call({
 String name, String sets, String reps, String? intensity, String? note
});
...
/// Create a copy of Exercise
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? sets = null,Object? reps = null,Object? intensity = freezed,Object? note = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String sets,  String reps,  String? intensity,  String? note)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Exercise() when $default != null:
return $default(_that.name,_that.sets,_that.reps,_that.intensity,_that.note);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String sets,  String reps,  String? intensity,  String? note)  $default,) {final _that = this;
switch (_that) {
case _Exercise():
return $default(_that.name,_that.sets,_that.reps,_that.intensity,_that.note);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String sets,  String reps,  String? intensity,  String? note)?  $default,) {final _that = this;
switch (_that) {
case _Exercise() when $default != null:
return $default(_that.name,_that.sets,_that.reps,_that.intensity,_that.note);case _:
  return null;
...
class _Exercise implements Exercise {
  const _Exercise({required this.name, required this.sets, required this.reps, this.intensity, this.note});
...
/// Create a copy of Exercise
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? sets = null,Object? reps = null,Object? intensity = freezed,Object? note = freezed,}) {
